            ...
            <tbody>
              {filtered.map((c) => (
                <tr key={c.ma_kh} className="border-b border-[var(--color-line)] last:border-0 hover:bg-black/[0.015]">
                  <td className="px-4 py-2.5 font-medium text-[var(--color-ink)]">{c.ma_kh}</td>
                  <td className="px-4 py-2.5">{c.ten_khach_hang}</td>
                  <td className="px-4 py-2.5 text-[var(--color-text-muted)]">{c.so_dt || c.email || '—'}</td>
                  <td className="px-4 py-2.5 text-[var(--color-text-muted)]">{c.nhom_kh || '—'}</td>
                  <td className="px-4 py-2.5 text-[var(--color-text-muted)]">{c.tenNvPhuTrach || '—'}</td>
