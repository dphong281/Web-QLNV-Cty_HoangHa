export const NHAN_VIEN_SYNONYMS = {
  ...
  'Số CCCD': ['so_cccd', 'so cccd', 'cccd', 'cmnd', 'so cmnd', 'can cuoc cong dan', 'cccd cmnd', 'cccd/cmnd'],
  'Ngày cấp CCCD': ['ngay_cap_cccd', 'ngay cap cccd', 'ngay cap'],
  'Nơi cấp': ['noi_cap', 'noi cap', 'noi cap cccd'],
  ...
  'Khối': ['khoi', 'phong ban', 'department'],
  'Chức vụ': ['chuc_vu', 'chuc vu', 'chuc danh', 'position'],
  'Cấp bậc': ['cap_bac', 'cap bac', 'rank'],
  'Nơi làm việc': ['noi_lam_viec', 'noi lam viec', 'don vi', 'tram', 'unit_name', 'bo phan'],
  'Ngạch': ['ngach'],
  ...
  'Trạng thái': ['trang_thai', 'trang thai', 'tinh trang', 'status', 'tinh trang lam viec'],
